<%-- 
    Document   : home
    Created on : 9 Feb, 2018, 2:23:31 PM
    Author     : Admin+
--%>
...
<head>
	<title>Instruction an Education Category Bootstrap Responsive Web Template | Home :: w3layouts</title>
	<!--/tags -->
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<nav class="link-effect-2" id="link-effect-2">
							<ul class="nav navbar-nav">
                                                            <li class="active"><a href="home.jsp" class="effect-3">Home</a></li>
                                                            <li><a href="notification.jsp" class="effect-3">Notification </a></li>
								<li><a href="services.html" class="effect-3">Sanction interview</a></li>
                                                                <li><a href="login_page.jsp" class="effect-3">Log out</a></li>
								<li class="dropdown">
									<a href="#" class="dropdown-toggle effect-3" data-toggle="dropdown">Approval image<b class="caret"></b></a>
									<ul class="dropdown-menu">
										<li><a href="codes.html">Add approval</a></li>
										<li><a href="icons.html">Remove approval</a></li>
									</ul>
								</li>
